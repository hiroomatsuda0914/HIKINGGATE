...
- AIプロンプトの言語切替方式
  - UI言語と同じ言語で回答させる方針を基本とするか。英語の場合は、日本語でAIに問い合わせてもらった回答を英語に翻訳して表示させたほうが、情報の鮮度が良い気もする
  - 風景や高山植物の写真を投稿して地図上の表示させ、カレンダーで表示期間のフィルタをする機能を実装する。
  - 投稿写真は、AIかAdminで承認してから表示する
